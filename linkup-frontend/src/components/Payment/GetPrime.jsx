...
export default function GetPrime() {
        ...
        const options = {
          ...
          handler: async function (response) {
            try {
              ...
              alert('Failed to activate prime');
            }
          }
        };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 pt-20 pb-10">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white text-lg font-bold rounded-xl shadow-lg hover:shadow-xl transform transition-all disabled:opacity-50"
            >
